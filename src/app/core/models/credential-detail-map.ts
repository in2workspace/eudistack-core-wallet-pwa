...
const employeeDetailMap = (s: any): DetailSection[] => [
  {
...
const machineDetailMap = (s: any): DetailSection[] => [
  {
...
const labelDetailMap = (s: any): DetailSection[] => [
  {
...
export const CredentialDetailMap: Record<CredentialType, CredentialDetailMapEntry> = {
  'learcredential.employee.w3c.4': employeeDetailMap,
  'learcredential.employee.sd.1': employeeDetailMap,
  'learcredential.machine.w3c.3': machineDetailMap,
  'learcredential.machine.sd.1': machineDetailMap,
  'gx.labelcredential.w3c.1': labelDetailMap,
};
