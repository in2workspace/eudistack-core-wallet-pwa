...
## [3.0.4](https://github.com/in2workspace/eudistack-core-wallet-pwa/releases/tag/v3.0.4)
### Fixed
-  Fix credential detail modal and verification modal closing incorrectly when the browser back button is pressed.       

### Changed
- Remove unused `QRCodeComponent` import from `CredentialsPage` and `VcSelectorPage`. 
